...
import com.example.locationtry.model.ListItem;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private void openDetailActivity(ApiResponse responseBody) {
        int dt = responseBody.getList().get(1).getDt();
        int humidity = responseBody.getList().get(1).getMain().getHumidity();
        double temp = responseBody.getList().get(1).getMain().getTemp();
        String description = responseBody.getList().get(0).getWeathers().get(1).getDescription();
